namespace DentalClinic.Windows
{
    ...
    public static class XmlHelper
    {
        ...
        public static T FromXmlFile<T>(string filePath)
        {
            ...
            {
                throw new Exception("There was an error attempting to read the file " + e);
            }
            finally
            {
                sr.Close();
        ...
        {
            string stringFromByteArray = Encoding.ASCII.GetString(byteArray);

            var result = FromXml<T>(stringFromByteArray);
